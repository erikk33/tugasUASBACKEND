...
<body>
    ...
    <button type="button" class="custom-button" onclick="location.href='tambah.php';">
  <span class="custom-button__text">Tambah Barang</span>
...
<table class="table table-striped table-dark">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
      <a href="ubah.php?id=<?=$row["id"]?>" class="edit-link">
